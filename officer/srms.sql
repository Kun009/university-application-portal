-- phpMyAdmission Officer SQL Dump
-- version 5.2.1
-- https://www.phpmyAdmission Officer.net/
--
-- Host: 127.0.0.1
...
--
-- Table structure for table `Admission Officer`
--

CREATE TABLE `Admission Officer` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `Admission Officer`
--

INSERT INTO `Admission Officer` (`id`, `UserName`, `Password`, `updationDate`) VALUES
(1, 'Admission Officer', 'f925916e2754e5e03f75dd58a5733251', '2024-03-10 10:30:57');
...
--
-- Indexes for table `Admission Officer`
--
ALTER TABLE `Admission Officer`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `Admission Officer`
--
ALTER TABLE `Admission Officer`

...
<head>
    ...
    <title>Manage Processing Applications</title>
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Manage Processing Applications</h2>
                            </div>
                        </div>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li> Applications</li>
                                    <li class="active">Manage Processing Applications</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="panel">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                <h5>View Processing Applications</h5>
                                            </div>
                                        </div>
                                        ...
                                        <div class="panel-body p-20">
                                            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    <?php 
                                                    // Fetching data from the tbl_applications where universityId = :unid and admissionstatus = 'processing'
                                                    $sql = "SELECT * FROM tbl_applications WHERE universityId = :unid AND admissionstatus = 'processing'";
                                                    $query = $dbh->prepare($sql);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="view-process.php?id=<?php echo htmlentities($result->id);?>" class="btn btn-info btn-xs"> View </a>
                                                        </td>
                                                    </tr>
                                                    <?php $cnt++; }
                                                    } else { ?>
                                                        <tr>
                                                            <td colspan="6" class="text-center">No applications in processing status.</td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>

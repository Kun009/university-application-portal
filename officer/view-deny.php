...
if(strlen($_SESSION['ologin']) == "") {   
    ...
    // Fetch the details of the denied applicant from tbl_applications using the appid
    $sql = "SELECT * FROM tbl_applications WHERE id = :appid AND admissionstatus = 'denied'";
    ...
    if (!$result) {
        die("No denied applicant found with the given ID.");
    }
?>
...
<head>
    ...
    <title>Denied Applicant Details</title>
                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Denied Applicant Details</h2>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <a href="deny.php" class="btn btn-primary">Back to Denied Applications</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>

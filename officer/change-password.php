...
$username=$_SESSION['ologin'];
    $sql ="SELECT Password FROM Admission Officer WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update Admission Officer set Password=:newpassword where UserName=:username";
...
<html lang="en">
    <head>
        ...
        <title>Admission Officer change password</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Admission Officer Change Password</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Admission Officer change password</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Admission Officer Change Password</h5>
                                                </div>
                                            </div>
           <?php if($msg){?>

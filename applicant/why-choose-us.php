...
<div class="relative bg-light-blue-100 py-20 overflow-hidden">
    ...
    <div class="container mx-auto my-10 px-4">
        <h1 class="text-4xl font-bold text-center text-blue-600 mb-6">Why Choose Us?</h1>
        
        <div class="text-center mb-10">
            <p class="text-lg text-gray-700">At UniApply, we believe in making the university application process as smooth and stress-free as possible. Here are some reasons why we stand out:</p>
        </div>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="p-6 border rounded-lg shadow-md hover:shadow-lg bg-white transition-shadow duration-300">
                <h3 class="text-2xl font-semibold mb-4 text-blue-500">Global University Network</h3>
                <p class="text-gray-700">We have partnerships with universities around the world, providing you with a wide range of options tailored to your academic interests and career goals.</p>
            </div>
            <div class="p-6 border rounded-lg shadow-md hover:shadow-lg bg-white transition-shadow duration-300">
                <h3 class="text-2xl font-semibold mb-4 text-blue-500">Personalized Guidance</h3>
                <p class="text-gray-700">Our team of experienced advisors is here to guide you at every step of your application process, ensuring you make informed decisions.</p>
            </div>
            <div class="p-6 border rounded-lg shadow-md hover:shadow-lg bg-white transition-shadow duration-300">
                <h3 class="text-2xl font-semibold mb-4 text-blue-500">Comprehensive Resources</h3>
                <p class="text-gray-700">From application checklists to essay writing tips, we provide all the resources you need to enhance your application and stand out.</p>
            </div>
            <div class="p-6 border rounded-lg shadow-md hover:shadow-lg bg-white transition-shadow duration-300">
                <h3 class="text-2xl font-semibold mb-4 text-blue-500">User-Friendly Platform</h3>
                <p class="text-gray-700">Our online platform is designed to be intuitive and easy to navigate, making your application journey straightforward and hassle-free.</p>
            </div>
            <div class="p-6 border rounded-lg shadow-md hover:shadow-lg bg-white transition-shadow duration-300">
                <h3 class="text-2xl font-semibold mb-4 text-blue-500">Success Stories</h3>
                <p class="text-gray-700">Join thousands of successful applicants who have secured their spots at top universities with our help. Read their stories and get inspired!</p>
            </div>
            <div class="p-6 border rounded-lg shadow-md hover:shadow-lg bg-white transition-shadow duration-300">
                <h3 class="text-2xl font-semibold mb-4 text-blue-500">24/7 Support</h3>
                <p class="text-gray-700">We are here for you around the clock. Our support team is always ready to assist you with any queries you might have.</p>
            </div>
        </div>
    </div>
    </div>

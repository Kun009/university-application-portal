...
<div class="relative bg-light-blue-100 py-20 overflow-hidden">
    ...
    <div class="container mx-auto my-10 px-4">
        <h1 class="text-4xl font-bold text-center mb-8">What Our Users Say</h1>
        <p class="text-gray-700 text-center mb-10">
            Hear from our satisfied users who have successfully navigated their university application journey with UniApply.
        </p>
...
<div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
    <p class="text-gray-600 mb-4">
        "UniApply made my application process so easy and stress-free! I found my dream university in no time."
    </p>
    <div class="flex items-center">
        <img src="../admission/uploads/james.jpg" alt="User 1" class="rounded-full mr-4 w-24 h-24 object-cover">
        <div>
            <h3 class="text-lg font-semibold">John Doe</h3>
            <p class="text-gray-500">Business Administration Student</p>
        </div>
    </div>
</div>
<!-- Testimonial 2 -->
<div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
    <p class="text-gray-600 mb-4">
        "The support I received from UniApply was amazing! They guided me through every step of the application."
    </p>
    <div class="flex items-center">
        <img src="../admission/uploads/jane.jpg" alt="User 2" class="rounded-full mr-4 w-24 h-24 object-cover">
        <div>
            <h3 class="text-lg font-semibold">Jane Smith</h3>
            <p class="text-gray-500">Engineering Student</p>
        </div>
    </div>
</div>
<!-- Testimonial 3 -->
<div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
    <p class="text-gray-600 mb-4">
        "I can't recommend UniApply enough! The platform was user-friendly, and I got accepted into my top choice!"
    </p>
    <div class="flex items-center">
        <img src="../admission/uploads/michael.jpg" alt="User 3" class="rounded-full mr-4 w-24 h-24 object-cover">
        <div>
...
<div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
    <p class="text-gray-600 mb-4">
        "With UniApply's help, I was able to find multiple universities that fit my needs perfectly."
    </p>
    <div class="flex items-center">
        <img src="../admission/uploads/anna.jpg" alt="User 4" class="rounded-full mr-4 w-24 h-24 object-cover">
        <div>
            <h3 class="text-lg font-semibold">Emily White</h3>
            <p class="text-gray-500">Arts Student</p>
        </div>
    </div>
</div>
<!-- Testimonial 5 -->
<div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
    <p class="text-gray-600 mb-4">
        "I loved how easy it was to keep track of my application status through UniApply!"
    </p>
    <div class="flex items-center">
        <img src="../admission/uploads/sarah.jpg" alt="User 5" class="rounded-full mr-4 w-24 h-24 object-cover">
        <div>
            <h3 class="text-lg font-semibold">Sarah Connor</h3>
...
<div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
    <p class="text-gray-600 mb-4">
        "UniApply's resources and guidance were invaluable in my search for the right university."
    </p>
    <div class="flex items-center">
        <img src="../admission/uploads/daniel.jpg" alt="User 6" class="rounded-full mr-4 w-24 h-24 object-cover">
        <div>
            <h3 class="text-lg font-semibold">Daniel Green</h3>
            <p class="text-gray-500">Mathematics Student</p>
        </div>
    </div>
</div>
